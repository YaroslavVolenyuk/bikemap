...
//   if (!api)
//     throw Error(
//       'Api must be initialized before it can be used. Use "setApi" when starting the app',
//     );
//   return api;
// }
...
//       throw new Error(
//         'There has been an error. Server responded with ' +
//           response.statusText +
//           ' (' +
//           response.status +
//           ')',
...
//       'locale',
//       langAndCountry.length > 0 ? langAndCountry[0] : 'en',
//     );
...
//       this.getRoutingURLWithKey('route').toString(),
//       {
//         method: 'POST',
//         mode: 'cors',
...
//             messagesFromHints +=
//               (messagesFromHints ? ' and ' : '') + messagesFromHints;
//             messagesFromHints += hint.message;
//           }
//         });
//         if (messagesFromHints)
...
//           Dispatcher.dispatch(
//             new RouteRequestSuccess(args, zoomOnSuccess, result),
//           );
//         } else {
//           const tmp =
//             JSON.stringify(args) +
...
//         if (routeNumber > this.lastRouteNumber) {
//           console.warn(
//             'error when performing /route request ' + routeNumber + ': ',
//             error,
//           );
//           this.lastRouteNumber = routeNumber;
...
//     let profileConfig = config.profiles
//       ? (config.profiles as any)[args.profile]
//       : {};
...
//     if (profileConfig?.details)
//       details = [...details, ...profileConfig.details]; // don't modify original arrays!
...
//       optimize: 'false',
//       points_encoded: true,
//       snap_preventions: config.request?.snapPreventions
//         ? config.request.snapPreventions
//         : [],
//       ...profileConfig,
//       details: details,
//     };
...
//         return {
//           ...instruction,
//           points: path.points.coordinates.slice(
